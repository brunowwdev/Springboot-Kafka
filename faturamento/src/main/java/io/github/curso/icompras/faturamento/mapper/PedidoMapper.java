package io.github.curso.icompras.faturamento.mapper;

import io.github.curso.icompras.faturamento.model.Cliente;
import io.github.curso.icompras.faturamento.model.ItemPedido;
import io.github.curso.icompras.faturamento.model.Pedido;
import io.github.curso.icompras.faturamento.subscriber.representation.DetalheItemPedidoRepresentation;
...
public class PedidoMapper {
    ...
    private ItemPedido mapItem(DetalheItemPedidoRepresentation representation) {
        return new ItemPedido(representation.codigoProduto(),representation.nome(),representation.quantidade(),representation.valorUnitario(),representation.total());
    }
}
